                    ...
                    <div class="border-bottom pb-4 mb-4">
                        ...
                        <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label" for="brandAdidas">{{$brand->brand_name}}
                                    <span class="text-gray-25 font-size-12 font-weight-normal">({{$brand->productCount}})</span>
                                </label>
                            </div>
                        </div>
                        @endforeach
                                ...
                                <div class="product-item__outer h-100">
                                    <div class="product-item__inner px-xl-4 p-3">
                                        <div class="product-item__body pb-xl-2">
                                            <div class="mb-2">
                                                <a href="/{{$product->slug}}" target="_blank" class="font-size-12 text-gray-5">
                                                    {{$product->category_name}}
                                                </a>
                                            </div>
                                            <h5 class="mb-1 product-item__title">
                                                <a href="/{{$product->slug}}" target="_blank" class="text-blue font-weight-bold">{{$product->product_name}}</a>
                                            </h5>
                                            <div class="mb-2">
                                            ...
                                            <div class="flex-center-between mb-1">
                                                ...
                                                <div class="d-none d-xl-block prodcut-add-cart">
                                                    <a> <button href="/shop/single-product-fullwidth" class="btn-add-cart btn-primary transition-3d-hover"><i class="ec ec-add-to-cart"></i></button>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>

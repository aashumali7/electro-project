                                    ...
                                    <div class="product-item__inner px-xl-4 p-3">
                                        <div class="product-item__body pb-xl-2">
                                            ...
                                            <h5 class="mb-1 product-item__title">
                                                <a href="../shop/single-product-fullwidth.html" class="text-blue font-weight-bold">{{$product->product_name}}</a>
                                            </h5>
                                            <div class="mb-2">
                                                <img class="img-fluid" src="{{$product->prod_thumbnail_img}}" alt="Image Description"></a>
                                            </div>
                                            @php
                                                $mrp = $product->mrp;

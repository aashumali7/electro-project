                    ...
                    <div class="d-none d-xl-block col-md-auto">
                        <div class="d-flex">
                            ...
                            <div class="ml-2">
                                ...
                                <div class="email">
                                    E-mail: <a href="mailto:{{$appData['support_email_address']}}?subject=Help Need" class="text-gray-90">{{$appData['support_email_address']}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col align-self-center">
                        ...
                        <form class="js-focus-state" method="GET" action="/shop/shop-grid">
                            ...
                            <div class="input-group">
                                <input type="search" class="form-control py-2 pl-5 font-size-15 border-0 height-40 rounded-left-pill" name="q" id="searchProduct" placeholder="Search for Products" aria-label="Search for Products" aria-describedby="searchProduct1" required>
                                <div class="input-group-append">
                                    <!-- Select -->
